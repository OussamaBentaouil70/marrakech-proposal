    ...
    >
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 lg:px-12 text-center">
        ...
        <motion.div
          ...
          className="ornament mb-10 max-w-xs mx-auto"
        >
          {eyebrow}
        </motion.div>
        ...
        <AnimatedText
          ...
          text={title}
          variant="lines"
          className="font-heading text-ivory mx-auto mb-8"
          style={{ fontSize: 'clamp(2.5rem, 6vw, 5rem)', lineHeight: 1.0, maxWidth: '900px' } as React.CSSProperties}
        />
        ...
        <motion.p
          ...
          className="font-body text-sm text-beige/70 leading-relaxed mb-12 max-w-lg mx-auto"
        >
          {subtitle}
        </motion.p>
